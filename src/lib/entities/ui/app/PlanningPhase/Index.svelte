...
<ScreenCard
	...
	btnText="Перейти к генерации тем"
	bgClass="bg-darkFuchsia"
...
>
	<div slot="body">
		{#if step != instructionLength}
			...
			<Range
				bind:defaultTimeForEvent={defaultTimeForEvent[step]}
				minMin={minSettings[step]}
				maxMin={maxSettings[step]}
				stepSetting={stepsSettings[step]}
			/>
		{:else}
