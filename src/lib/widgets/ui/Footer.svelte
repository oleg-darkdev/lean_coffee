...
<footer class="w-full bg-gray-100 py-16 ">
	<div class="md:px-12 lg:px-28">
		<div class="container m-auto space-y-6 text-gray-600 ">
			<img src="images/logo.svg" alt="logo Lean Coffee Kit" class="m-auto w-40" />
			<ul
				role="list"
				class="flex flex-col items-center justify-center gap-4 py-4 sm:flex-row sm:gap-8"
			>
				{#each links as link}
					<li role="listitem"><a href={link.link} class="hover:text-primary">{link.title} </a></li>
				{/each}
			</ul>
			...
			<div class="text-center">
				<span class="text-sm tracking-wide"
					>Copyright © Lean Coffee Kit <span id="year" /> | All right reserved</span
				>
			</div>
		</div>
	</div>
